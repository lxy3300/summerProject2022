...
if __name__ == "__main__":
    path_to_halifax = '../Halifax_data/accident_number/accident_number.shp'
    ...
    plt.savefig("../Halifax_image/map_centroid.png", dpi=600)
    ...
    for index, row in halifax_center.iterrows():
        ...
        plt.annotate(
            ...
            ha='center', va='center',
            size=3)
    plt.savefig("../Halifax_image/map_number.png", dpi=600)
